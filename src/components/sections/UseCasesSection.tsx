    ...
    <div className="w-full space-y-3 sm:space-y-4">
      ...
      <div className="grid grid-cols-3 gap-2 sm:gap-4">
        <div className="flex items-center justify-center bg-white rounded-2xl sm:rounded-2xl p-2 sm:p-4">
          <LoadingImage src="/mtn-logo.jpg" alt="MTN Mobile Money" width={120} height={120} className="rounded-2xl sm:rounded-2xl w-full h-auto" />
        </div>
        <div className="flex items-center justify-center bg-white rounded-2xl sm:rounded-2xl p-2 sm:p-4">
          <LoadingImage src="/telecel-logo.webp" alt="Telecel Cash" width={120} height={120} className="rounded-2xl sm:rounded-2xl w-full h-auto" />
        </div>
        <div className="flex items-center justify-center bg-white rounded-2xl sm:rounded-2xl p-2 sm:p-4">
          <LoadingImage src="/airteltigo-logo.png" alt="AirtelTigo Cash" width={120} height={120} className="rounded-2xl sm:rounded-2xl w-full h-auto" />
        </div>
      </div>
      {/* Card + Cash row */}
      <div className="grid grid-cols-3 gap-2 sm:gap-4">
        <div className="flex items-center justify-center bg-white rounded-2xl sm:rounded-2xl p-2 sm:p-4">
          <LoadingImage src="/visa-logo.png" alt="Visa" width={120} height={120} className="rounded-2xl sm:rounded-2xl w-full h-auto" />
        </div>
        <div className="flex items-center justify-center bg-white rounded-2xl sm:rounded-2xl p-2 sm:p-4">
          <LoadingImage src="/mastercard-logo.png" alt="Mastercard" width={120} height={120} className="rounded-2xl sm:rounded-2xl w-full h-auto" />
        </div>
